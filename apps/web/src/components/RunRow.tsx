...
export function RunRow({
  ...
  return (
    <div className="flex items-center gap-2 pr-3 transition-colors hover:bg-raised">
      <Link
        to={`/runs/${run.id}`}
        className="flex flex-1 items-start gap-3 px-4 py-3 focus-visible:bg-raised sm:items-center"
      >
